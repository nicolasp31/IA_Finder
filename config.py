...
PALABRAS_CLAVE_IA = [
    ...
    "http://cv.iptc.org/newscodes/digitalsourcetype/compositeWithTrainedAlgorithmicMedia", "Edited with Google AI"
]
...
ETIQUETAS_APLICACION = {
    ...
    , "Edited with Google AI": ["Gemini (Google)"], "Made with Google AI": ["Gemini (Google)"]
}
