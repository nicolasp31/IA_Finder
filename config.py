...
etiquetas_excluidas = ["SourceFile", "FileName"] # etiquetas excluidas del analisis

# etiquetas que confirman la generacion de archivos mediante IA
PALABRAS_CLAVE_IA = [
    ...
    "http://cv.iptc.org/newscodes/digitalsourcetype/compositeWithTrainedAlgorithmicMedia", "Edited with Google AI","adobe_c2pa/0.12.4+sven2 c2pa-rs/0.32.7"
    ,"Adobe_Firefly"
]

# etiquetas sospechosas de generacion de archivos mediante IA
PALABRAS_POSIBLES_IA = [
    ...
    "WeasyPrint 65.1","PyFPDF 1.7.2 http://pyfpdf.googlecode.com/", "www.reportlab.com", "Skia/PDF m83","Chromium","Skia/PDF m127",
...
# etiquetas que contienen unicamente valores numericos o fechas
NUMEROS_FECHAS_CLAVE = [
    "2013:12:23 23:15:00Z", "12.0000", "2023:08:21 21:53:30Z", "0000:00:00 00:00:00", "1980"
]

# etiquetas que confirman el modelo de generacion de archivos
ETIQUETAS_MODELO = {
    ...
    "Lavf60.16.100": "SORA (OpenAI)", "Microsoft Video Provenance": "SORA (OpenAI)", "prompt": "StableDifusion", "Edited with Google AI":"IMAGEN (Google)"
    ,"python-docx": "GPT-4/5 ",
}

# etiquetas que confirman la aplicacion de generacion de archivos
ETIQUETAS_APLICACION = {
    "ChatGPT": ["ChatGpt"], "Azure OpenAI ImageGen": ["Copilot"], "Image Creator from Designer": ["Bing"], "API": ["Perplexity"],
    "Adobe Firefly": ["Adobe Firefly"], "Ideogram AI": ["ideogram"], "prompt": ["Raphael", "StableDifusion", "Giz"],
    "Created using InVideo AI.": ["InVideoAI"], "Microsoft Video Provenance": ["Bing"], "generated by python-docx": ["ChatGpt", "Perplexity"]
    , "Edited with Google AI": ["Gemini (Google)"], "Made with Google AI": ["Gemini (Google)"], "Adobe_Firefly": ["Adobe Firefly"]
}

# etiquetas sospechosas de la aplicacion de generacion de archivos
ETIQUETAS_POSIBLE_APLICACION = {
    "Microsoft Word 12.0.0": ["Aidocmaker"], "12.000": ["chatgpt","aidocmaker"], "WeasyPrint 65.1": ["aidockmaker"],
    "Skia/PDF ": ["Hotform","perplexity"], "CREATOR: gd-jpeg v1.0 (using IJG JPEG v62)": ["aidcokmaekr"], "html-to-docx":["perplexity"],
    ...
    "2023:08:21 21:53:30Z": ["aidocmaker"], "LibreOffice/25.2.4.3$Linux_X86_64 ": ["slidesgo"],"python-docx":["chatGpt","perplexity"],
